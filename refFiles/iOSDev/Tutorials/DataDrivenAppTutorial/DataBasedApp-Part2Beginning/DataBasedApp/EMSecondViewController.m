...
- (IBAction)showTableViewController:(id)sender {
    ...
    TableViewController *tmpTableViewController = [[TableViewController alloc] init];
    [self.navigationController pushViewController:tmpTableViewController animated:TRUE];
