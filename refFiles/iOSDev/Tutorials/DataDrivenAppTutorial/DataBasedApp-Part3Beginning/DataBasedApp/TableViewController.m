...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.image = [UIImage imageNamed:[(City*)[self.data.cities objectAtIndex:indexPath.row]thumbnail]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CityInformationViewController *cityInfoViewController =[[CityInformationViewController alloc] initWithNibName:@"CityInformationViewController" bundle:nil];
