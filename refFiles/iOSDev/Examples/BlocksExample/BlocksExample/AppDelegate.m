...
//    NSString* myNewString = [myString joinTwoStrings: ^(id str1, id str2) {
//        return [str1 stringByAppendingString:str2];
 //   }];
    ...
    NSLog(@"ResultFromBlock: %i", resultFromBlock);
    
    int multiplyFromBlock = self.multiply(2,5);
    NSLog(@"ResultFromBlock: %i", multiplyFromBlock);
    return YES;
}
