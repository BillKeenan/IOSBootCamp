...
- (void)reloadProfile
{
    ...
    SLRequest *request = [SLRequest
                          ...
                          parameters:@{ @"fields" : @"bio,birthday,cover,email,first_name,gender,hometown,languages,last_name,link,location,picture,relationship_status,security_settings,username,website" }];
