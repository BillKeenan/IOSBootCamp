...
@interface GTMasterViewController() <UIAlertViewDelegate, EKEventEditViewDelegate, EKCalendarChooserDelegate>
{
    NSArray* shows; //2
}
@end
...
-(void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if (buttonIndex==0) {
        ...
        [self addShow:shows[row] toCalendar:[AppCalendar calendar]];
    }
...
-(void)addShow:(NSDictionary*)show toCalendar:(EKCalendar*)calendar
{
    ...
    //3
    EKRecurrenceRule* myReccurrence = [[EKRecurrenceRule alloc] initRecurrenceWithFrequency:EKRecurrenceFrequencyWeekly
                                                                                   interval:1
...
- (void)calendarChooserDidFinish:(EKCalendarChooser*)calendarChooser
{
    ...
    //3
    [self addShow: [shows objectAtIndex:row] toCalendar: selectedCalendar];
